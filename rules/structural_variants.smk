...
rule make_INS_bed_file:
    ...
    shell:
        ...
        grep {params.grep_chr} 2>> {log} | sort {params.sort} 2>> {log} | \
...
rule make_duplications_bed_file:
    ...
    shell:
        ...
        grep {params.grep_chr} 2>> {log} | cut {params.select_columns} 2>> {log} | \
...
rule make_translocations_bedpe_file:
    ...
    shell:
        ...
        grep {params.grep_chr} 2>> {log} | awk {params.fix_columns} 2>> {log} | \
        cut {params.select_columns} 2>> {log} | sort {params.sort} > {output} 2>> {log}"

#========================================================================================
# Rules to find regions that need filtering out based on coverage levels and mappability.
#========================================================================================
